...
def primes_in_range_exporter(file_path, fibonacci_nums, primes_in_range):
    header = [
        'index', 'f_num', 'f_sum', 'range_start', 'range_end', 'n_nums_in_range', 'primes_in_range', 'n.len / p.len']
    ...
    for idx, p_range in enumerate(primes_in_range):
        ...
        data += [[index, f_num, f_sum, f_sum_range[0], f_sum_range[-1], n_nums_in_range, p_in_range, np_division]]

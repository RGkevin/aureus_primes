...
def positional_primes_generator(possible_primes, positional_counter_primes, max_prime_idx):
    ...
    for factor in factors_range:
        ...
        half_factor_is_prime = positional_counter_primes[half_factor_idx]
        ...
        if half_factor_is_prime:
            ...
            positional_counter_primes[composites_start_idx::factor] = False
        # print('positional_primes_generator.positional_primes \n', positional_primes)

    return positional_counter_primes
